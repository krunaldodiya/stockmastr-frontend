...
import { NetInfo, Alert, StyleSheet } from "react-native";
import {
  View,
  Text,
  Button,
...
class GetStartedScreen extends React.Component {
              ...
              >
                <Form>
                  <View style={{ flex: 1 }}>
                    ...
                    <Content ref="Content" bounces={false}>
                      <Text>
                        ...
                        Rackham. Where can I get some? There are many variations
  ...
  acceptTerms() {
    this.props.navigation.replace("OauthScreen");
  }
}
